...
describe('Audit Logging', () => {
  it('should log all transfer operations', async () => {
    ...
    const receiver = await (global as any).createUser({ tier: 'organization', parentAgencyId: sender.id });
  ...
  it('should log all block operations', async () => {
    ...
    const blocked = await (global as any).createUser({ tier: 'organization', parentAgencyId: blocker.id });

        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-600">
              ...
              >
                Service{' '}
                {sortConfig.key === 'service' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
              </th>
              <th
                className="text-left py-3 px-2 text-gray-300 cursor-pointer hover:text-white"
          ...
          <tbody>
            {paginatedEndpoints.map((endpoint, index) => (
              ...
              >
                ...
                <td className="py-3 px-2">
                  <span
                    className={`px-2 py-1 rounded text-xs ${getSLATierColor(endpoint.slaTier)}`}
                  >
                ...
                <td className="py-3 px-2 text-right text-gray-300">
                  {endpoint.metrics.count.toLocaleString()}
                </td>

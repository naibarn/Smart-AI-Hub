...
router.put('/:id',
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      if (error.message === 'Not authorized to update this agent' || 
...
router.post('/:id/submit',
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      if (error.message === 'Not authorized to submit this agent' || 
...
router.delete('/:id',
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      if (error.message === 'Not authorized to delete this agent' || 

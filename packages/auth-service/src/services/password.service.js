...
class PasswordService {
   ...
   */
  async storeResetToken(token, userId, ttl = 3600) {
   ...
   */
  async logResetAttempt(email, ip, userAgent, success) {
  ...
  async invalidateUserSessions(userId) {
    try {
      ...
      // Note: Access tokens are stateless JWTs
      // In a real implementation, you would need to track active access tokens
      // or use a shorter expiration time for access tokens
      // For this implementation, we'll focus on invalidating refresh tokens
